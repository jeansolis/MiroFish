...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by Zep SDK; warnings from dynamic class creation can be safely ignored
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Get full graph data (with detailed info)
        
        Args:
            graph_id: Graph ID
            
        Returns:
            Dictionary with nodes and edges, including timestamps, attributes, and other details
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
