...
class ZepEntityReader:
    ...
    3. Get related edges and connected node info for each entity
    """
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Max retry count (default 3, i.e., up to 3 attempts)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node has only the "Entity" label, it does not match predefined types and is skipped
        - If a node has labels beyond "Entity" and "Node", it matches predefined types and is kept
        
        Args:
            graph_id: Graph ID
            defined_entity_types: Predefined entity type list (optional, only keeps these types if provided)
