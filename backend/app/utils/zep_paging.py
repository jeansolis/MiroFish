...
This module wraps auto-paging logic (with per-page retry), transparently returning complete lists to callers.
"""
...
def fetch_all_nodes(
    ...
    """Paginated fetch of graph nodes, max max_items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
