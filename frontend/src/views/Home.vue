            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if a university issued a reinstatement notice?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
